...
import com.example.calculator2.Models.Calculator
...
class MainActivity : AppCompatActivity() {
    ...
    fun buttonClick(v: View){
        ...
        when(v.id){
            ...
            R.id.btnSubstract -> ans = calculator.subtract()
            R.id.btnDevide -> ans = calculator.multiply()
            R.id.btnMultiply -> ans = calculator.divide()
        }
